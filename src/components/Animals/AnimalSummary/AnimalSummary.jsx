  ...
  return (
    <>
      <Stack direction="row" spacing={1} sx={{ alignItems: "center" }}>
        <Typography variant="h5">Animal Details</Typography>
        {!edit && (
          <IconButton
      ...
      <Paper sx={{ padding: 3 }}>
        <img width="auto" src={animal.image} />
        ...
        <Stack spacing={2}>
          ...
          <Autocomplete
            ...
            renderInput={(params) => (
              <TextField {...params} label="Animal Type" placeholder="Types" />
            )}
          />
          ...
          <Autocomplete
            ...
            value={
              animal.sex !== null
                ? { label: animal.sex, value: animal.sex }
                : { label: "N/A", value: null }
            }
            ...
            renderInput={(params) => (
              <TextField {...params} label="Sex" placeholder="Sex" />
            )}
          />
          ...
          <Autocomplete
            ...
            value={
              animal.active
                ? { label: "Active", value: animal.active }
                : { label: "Inactive", value: animal.active }
            }
            isOptionEqualToValue={(option, value) =>
              option.value === value.value
            }
